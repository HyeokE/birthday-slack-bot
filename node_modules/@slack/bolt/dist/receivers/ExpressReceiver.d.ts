...
export default class ExpressReceiver implements Receiver {
    ...
    constructor({ signingSecret, logger, logLevel, endpoints, processBeforeResponse, clientId, clientSecret, stateSecret, installationStore, scopes, installerOptions, }: ExpressReceiverOptions);
