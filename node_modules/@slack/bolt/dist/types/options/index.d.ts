...
declare type OptionsPayloadFromType<T extends string> = KnownOptionsPayloadFromType<T> extends never ? BasicOptionsPayload<T> : KnownOptionsPayloadFromType<T>;
declare type KnownOptionsPayloadFromType<T extends string> = Extract<SlackOptions, {
    type: T;
}>;
/**
